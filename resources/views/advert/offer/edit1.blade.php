                ...
                <form action="{{route('advert.offers.update', $id)}}" method="PATCH" class="nau-form" id="createOfferForm" target="_top">
                    ...
                    <div class="tab-content">
                        <div id="tab_wdt1" class="tab-pane fade">
                            ...
                            <p class="control-check-left"><input name="____wd_working_days" type="checkbox" id="check_wd8"
                                                                 @if(isset($workingDays['mo']) && isset($workingDays['tu'])
                                                                 && isset($workingDays['we']) && isset($workingDays['th']) && isset($workingDays['fr'])
                                                                 ) checked @endif><label for="check_wd8"><span class="input-label">Working Days</span></label></p>
                            <p class="control-check-left"><input name="____wd_weekend" type="checkbox" id="check_wd9"
                                                                 @if(isset($workingDays['su']) && isset($workingDays['sa'])) checked @endif><label for="check_wd9"><span class="input-label">Weekend</span></label></p>
                            <p class="title">Working time</p>
                            <p class="row control-datetime">
                                <label class="col-xs-6"><span class="input-label">from</span> <input name="start_time" readonly class="js-timepicker" value="" id="time_wd8f"
                                                                                                     placeholder="__:__"></label>
                                <label class="col-xs-6"><span class="input-label">to</span> <input name="finish_time" readonly class="js-timepicker" value="" id="time_wd8t"
                                                                                                   placeholder="__:__"></label>
                            </p>
                        </div>
                        ...
                        <div id="tab_wdt2" class="tab-pane fade in active" data-workingdays="{{ json_encode($workingDays) }}">
                            ...
                            <p class="row day-info">
                                <span class="col-xs-2">
                                    <span class="control-check-left"><input name="____wd_mon" type="checkbox" id="check_wd1" data-relation="check_wd8" data-weekday="mo"
                                                                            @if(isset($workingDays['mo'])) checked @endif><label for="check_wd1">&nbsp;</label>
                                    </span>
                                </span>
                                <strong class="col-xs-2">Mon</strong>
                                <span class="col-xs-4 control-datetime">
                                        <label><input name="____start_time_mon" readonly class="js-timepicker" value="" data-relation="time_wd8f" data-weekday="mo"
                                                      placeholder="@if(isset($workingDays['mo']['from'])){{$workingDays['mo']['from']}}@endif"></label>
                                    </span>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____finish_time_mon" readonly class="js-timepicker" value="" data-relation="time_wd8t" data-weekday="mo"
                                                  placeholder="@if(isset($workingDays['mo']['to'])){{$workingDays['mo']['to']}}@endif"></label>
                                </span>
                            </p>
                            <p class="row day-info">
                                <span class="col-xs-2">
                                    <span class="control-check-left"><input name="____wd_tue" type="checkbox" id="check_wd2" data-relation="check_wd8" data-weekday="tu"
                                                                            @if(isset($workingDays['tu'])) checked @endif><label for="check_wd2">&nbsp;</label></span>
                                </span>
                                <strong class="col-xs-2">Tue</strong>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____start_time_tue" readonly class="js-timepicker" value="" data-relation="time_wd8f" data-weekday="tu"
                                                  placeholder="@if(isset($workingDays['tu']['from'])){{$workingDays['tu']['from']}}@endif"></label>
                                </span>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____finish_time_tue" readonly class="js-timepicker" value="" data-relation="time_wd8t" data-weekday="tu"
                                                  placeholder="@if(isset($workingDays['tu']['to'])){{$workingDays['tu']['to']}}@endif"></label>
                                </span>
                            </p>
                            <p class="row day-info">
                                <span class="col-xs-2">
                                    <span class="control-check-left"><input name="____wd_wed" type="checkbox" id="check_wd3" data-relation="check_wd8" data-weekday="we"
                                                                            @if(isset($workingDays['we'])) checked @endif><label for="check_wd3">&nbsp;</label>
                                    </span>
                                </span>
                                <strong class="col-xs-2">Wed</strong>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____start_time_wed" readonly class="js-timepicker" value="" data-relation="time_wd8f" data-weekday="we"
                                                  placeholder="@if(isset($workingDays['we']['from'])){{$workingDays['we']['from']}}@endif"></label>
                                </span>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____finish_time_wed" readonly class="js-timepicker" value="" data-relation="time_wd8t" data-weekday="we"
                                                  placeholder="@if(isset($workingDays['we']['from'])){{$workingDays['we']['to']}}@endif"></label>
                                </span>
                            </p>
                            <p class="row day-info">
                                <span class="col-xs-2">
                                    <span class="control-check-left"><input name="____wd_thu" type="checkbox" id="check_wd4" data-relation="check_wd8" data-weekday="th"
                                                                            @if(isset($workingDays['th'])) checked @endif><label for="check_wd4">&nbsp;</label></span>
                                </span>
                                <strong class="col-xs-2">Thu</strong>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____start_time_thu" readonly class="js-timepicker" value="" data-relation="time_wd8f" data-weekday="th"
                                                  placeholder="@if(isset($workingDays['th']['from'])){{$workingDays['th']['from']}}@endif"></label>
                                </span>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____finish_time_thu" readonly class="js-timepicker" value="" data-relation="time_wd8t" data-weekday="th"
                                                  placeholder="@if(isset($workingDays['th']['to'])){{$workingDays['th']['to']}}@endif"></label>
                                </span>
                            </p>
                            <p class="row day-info">
                                <span class="col-xs-2">
                                    <span class="control-check-left"><input name="____wd_fri" type="checkbox" id="check_wd5" data-relation="check_wd8" data-weekday="fr"
                                                                            @if(isset($workingDays['fr'])) checked @endif><label for="check_wd5">&nbsp;</label></span>
                                    </span>
                                <strong class="col-xs-2">Fri</strong>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____start_time_fri" readonly class="js-timepicker" value="" data-relation="time_wd8f" data-weekday="fr"
                                                  placeholder="@if(isset($workingDays['fr']['from'])){{$workingDays['fr']['from']}}@endif"></label>
                                </span>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____finish_time_fri" readonly class="js-timepicker" value="" data-relation="time_wd8t" data-weekday="fr"
                                                  placeholder="@if(isset($workingDays['fr']['to'])){{$workingDays['fr']['to']}}@endif"></label>
                                </span>
                            </p>
                            <p class="row day-info">
                                <span class="col-xs-2">
                                    <span class="control-check-left"><input name="timeframes['days'][]" value="sa" type="checkbox" id="check_wd6" data-weekday="sa" data-relation="check_wd9"
                                                                            @if(isset($workingDays['sa'])) checked @endif><label for="check_wd6">&nbsp;</label>
                                    </span>
                                </span>
                                <strong class="col-xs-2">Sat</strong>
                                <span class="col-xs-4 control-datetime">
                                        <label><input name="____start_time_sat" readonly class="js-timepicker" value="" data-relation="time_wd8f" data-weekday="sa"
                                                      placeholder="@if(isset($workingDays['sa']['from'])){{$workingDays['sa']['from']}}@endif"></label>
                                </span>
                                <span class="col-xs-4 control-datetime">
                                        <label><input name="____finish_time_sat" readonly class="js-timepicker" value="" data-relation="time_wd8t" data-weekday="sa"
                                                      placeholder="@if(isset($workingDays['sa']['to'])){{$workingDays['sa']['to']}}@endif"></label>
                                </span>
                            </p>
                            <p class="row day-info">
                                <span class="col-xs-2">
                                    <span class="control-check-left"><input name="timeframes['days'][]" value="su" type="checkbox" id="check_wd7" data-weekday="su" data-relation="check_wd9"
                                                                            @if(isset($workingDays['su'])) checked @endif><label for="check_wd7">&nbsp;</label></span>
                                </span>
                                <strong class="col-xs-2">Sun</strong>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____start_time_sun" readonly class="js-timepicker" value="" data-relation="time_wd8f" data-weekday="su"
                                                  placeholder="@if(isset($workingDays['su']['from'])){{$workingDays['su']['from']}}@endif"></label>
                                </span>
                                <span class="col-xs-4 control-datetime">
                                    <label><input name="____finish_time_sun" readonly class="js-timepicker" value="" data-relation="time_wd8t" data-weekday="su"
                                                  placeholder="@if(isset($workingDays['su']['to'])){{$workingDays['su']['to']}}@endif"></label>
                                </span>
                            </p>
