...
<script type="text/javascript">
    (function() {
        window.nau_qr = new Print_QR();
        nau_qr.applyMainStyles();
        nau_qr.applyListeners();
        ...
        function Print_QR() {
            ...
            this.qr_wrapper = document.getElementById('qr_wrapper');
            ...
            this.applyMainStyles = function () {
                let storageStyles = self.getStyles();
                if (storageStyles) {
            ...
            function render() {
                ...
                let qr_title = self.qr_wrapper.getElementsByClassName('title')[0];
            ...
            function createImages(src) {
                ...
                for (let i = 0; i < QRData.image_count; i++) {
                    ...
                    self.qr_wrapper.appendChild(imgBlock);
                }
            }

            function removeImages() {
                let imgBlocks = self.qr_wrapper.querySelectorAll('.qr-item');
